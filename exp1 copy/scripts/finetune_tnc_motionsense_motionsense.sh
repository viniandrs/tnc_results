...
./tnc.py fit \
    --data ./../../../data/standartized_balanced/MotionSense \
    --epochs 100 \
    --batch_size 128 \
    --accelerator gpu \
    --devices 1 \
    --load_backbone logs/pretrain/TNC/MotionSense/checkpoints/last.ckpt \
...
new_result_folder_name=motionsense_motionsense
